...
public:
    ...
    void setupUi(QWidget *gpio)
    {
        ...
        label_2->setGeometry(QRect(170, 460, 660, 40));
        QPalette palette;
        ...
        label_3 = new QLabel(gpio);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(20, 510, 960, 80));
        QPalette palette1;
    ...
    void retranslateUi(QWidget *gpio)
    {
        ...
        label_3->setText(QApplication::translate("gpio", "<html><head/><body><p><span style=\" color:#ef2929;\">You can also perform batch operations on GPIO ports, </span></p><p><span style=\" color:#ef2929;\">but please add a comma between each GPIO port.</span></p></body></html>", nullptr));
    } // retranslateUi
