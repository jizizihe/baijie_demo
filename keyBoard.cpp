...
//    this->setAttribute(Qt::WA_ShowWithoutActivating,true);
    ...
    infoLabel->setText(tr("tttttttttttt"));
...
void keyBoard::changeType(QString type)
{
    ...
    {
        typeBtn->setText(tr("CAP"));
        changeLetter(true);
    }
    else
    {
        typeBtn->setText(tr("SPE"));
